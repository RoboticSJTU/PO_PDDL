...
from .modules import (
    LLMInitDescriptionContradictionReviewModule,
    VLMInitContradictionConfirmationModuleLLM,
    VLMInitObservationUncertainPredicateDiscoveryModule,
)
...
def build_learner_from_args(args: Namespace) -> tuple[InitObservationLearner, ModuleModeSummary]:
    ...
    learner = InitObservationLearner(
        uncertain_predicate_discovery_module=VLMInitObservationUncertainPredicateDiscoveryModule(
            model=model,
            api_key=api_key,
            base_url=base_url,
        ...
        description_review_module=LLMInitDescriptionContradictionReviewModule(
            model=model,
            api_key=api_key,
            base_url=base_url,
            temperature=temperature,
        ...
        vlm_confirmation_module=VLMInitContradictionConfirmationModuleLLM(
            model=model,
            api_key=api_key,
            base_url=base_url,
            temperature=temperature,
